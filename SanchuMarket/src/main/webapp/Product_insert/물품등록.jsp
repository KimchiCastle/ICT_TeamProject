...
<!-- 							<img id="imgup_2" onclick="send();"
 ...
 -->
				...
				<tr>
					...
					<td width="70%;" align="left"><input maxlength="40"
				...
				<tr>
					<td width="30%;" align="left" style="vertical-align: top;"><span
						class="pro_info">상태<span style="color: red">*</span></span></td>
					<td width="70%;" align="left"><input type="radio"
						name="p_condition" id="p_condition" value="중고상품"> <span
						class="pro_info">중고상품</span> <input type="radio"
				...
				<tr>
					...
					<td width="70%;" align="left"><input type="text" id="p_price"
				...
				<tr>
					<td colspan="2"><input type="button" value="등록하기"> <input
